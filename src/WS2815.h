...
class WS2815Controller : public CLEDController
{
...
public:
  ...
  void setAPA102Brightness(uint8_t br) { bBaseValue = 0xE0 | (br & 0x1F); }

  uint8_t getAPA102Brightness() { return (bBaseValue & 0x1F); }
